...
import com.suchgame.stackz.gl.util.Semaphore;
...
public class SceneGraphAnalysor implements ISceneGraphAnalysor {
	...
	private final Semaphore noValidRenderLinearizationLock = new Semaphore();
	private final Semaphore noValidInteractionLinearizationLock = new Semaphore();
