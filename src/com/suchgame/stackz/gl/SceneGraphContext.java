...
public abstract class SceneGraphContext {
	...
	protected boolean lastLastFrameWasIdle;
	...
	public final void basicReset(SceneGraphContext basicContext){
		...
		lastLastFrameWasIdle = lastFrameWasIdle;
...
//		z0VisibleTrapezoid.setDirty();
//		z0VisibleTrapezoid.getBoundingBox(z0BoundingBox);
		
//		*Quick hack instead:*
		z0VisibleTrapezoid.getQuickBoundingBox(z0BoundingBox);
