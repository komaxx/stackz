...
/**
 * A node that contains just one colored quad and places it randomly in a square
 * field. Useful for benchmarks.
 * 
...
public class OneQuadNode extends Node {
	...
	public boolean onRender(RenderContext renderContext) {
		...
		ColorQuad.renderColored(currentRenderProgram, 0, 1, quadsData,
				quadsIndices);
