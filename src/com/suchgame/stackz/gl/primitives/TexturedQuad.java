...
public class TexturedQuad {
	...
	/**
	 * Creates indices (beginning at 0) for the given count of quads.
	 */
	...
	public static void writeReversedIndices(ShortBuffer target, short[] toReverse) {
		target.put(toReverse[0]);
		target.put(toReverse[2]);
		target.put(toReverse[1]);
		target.put(toReverse[3]);
		target.put(toReverse[5]);
		target.put(toReverse[4]);
	}	
}
